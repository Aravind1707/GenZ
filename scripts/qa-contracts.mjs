...
check('inventory UI uses canonical material endpoint', has('app/(staff)/inventory/stock/page.tsx', /fetch\('\/api\/inventory\/materials\?action=materials'/) && has('app/(staff)/inventory/stock/page.tsx', /action,qty/) && has('app/api/inventory/materials/route.ts', /action==='adjust'/) && has('app/api/inventory/materials/route.ts', /action==='settings'/));
check('inventory receiving and stocktake use canonical material endpoint', has('app/(staff)/inventory/receiving/page.tsx', /action:'receive'/) && has('app/api/inventory/materials/route.ts', /action==='receive'/) && has('app/(staff)/inventory/stocktakes/page.tsx', /stocktake-complete/) && has('app/api/inventory/materials/route.ts', /action==='stocktake-complete'/));

...
export async function GET(){
 try{
  ...
  return NextResponse.json({ok:true,authenticated:!!customer,pricing:await getCustomerPricing(customer?.member_id||null)},{headers:{'Cache-Control':'private,no-store'}});

...
const nav=[['/','Dashboard'],['/sessions','Sessions'],['/settlements','Settlements'],['/receipts','Receipts'],['/daily-close','Daily Close'],['/bookings','Bookings'],['/orders','Food Orders'],['/kitchen','Kitchen'],['/inventory','Inventory'],['/finance','Finance'],['/members','Members'],['/stations','Stations']];

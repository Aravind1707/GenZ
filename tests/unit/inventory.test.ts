...
test('FIFO COGS consumes oldest valid batch first',()=>assert.equal(fifo([{remaining:5,cost:100,expiry:'2026-12-01'},{remaining:10,cost:150,expiry:'2026-12-10'}],8),950));

...
ALTER TABLE session_payment_refunds
  ADD COLUMN provider VARCHAR(80) NULL AFTER method,
  ADD COLUMN external_reference VARCHAR(160) NULL AFTER provider,
  ADD COLUMN provider_status ENUM('NOT_SENT','PENDING','SUCCEEDED','FAILED') NOT NULL DEFAULT 'NOT_SENT' AFTER external_reference;

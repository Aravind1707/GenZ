...
ALTER TABLE daily_cash_counts
  ADD COLUMN status ENUM('OPEN','APPROVED') NOT NULL DEFAULT 'OPEN' AFTER counted_cash,
  ADD COLUMN approved_by VARCHAR(64) NULL AFTER counted_by,
  ADD COLUMN approved_at DATETIME(3) NULL AFTER counted_at;
